...
_C.TASK.ACTIONS.TAKE_PICTURE = CN()
_C.TASK.ACTIONS.TAKE_PICTURE.TYPE = "TakePicture"
...
_C.TASK.FOW_MAP.MAP_RESOLUTION = 1250
_C.TASK.FOW_MAP.VISIBILITY_DIST = 6.0
_C.TASK.FOW_MAP.FOV = 79
_C.TASK.FOW_MAP.FOG_OF_WAR = CN()
_C.TASK.FOW_MAP.FOG_OF_WAR.DRAW = True
_C.TASK.FOW_MAP.FOG_OF_WAR.VISIBILITY_DIST = 6.0
_C.TASK.FOW_MAP.FOG_OF_WAR.FOV = 79
# -----------------------------------------------------------------------------
# PICTURE_MAP
# -----------------------------------------------------------------------------
...
_C.TASK.SMOOTH_MAP_VALUE.DRAW_BORDER = False
# -----------------------------------------------------------------------------
