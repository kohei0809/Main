...
#フォルダがない場合は、作成
p_dir = pathlib.Path("./result/train/exp_area_graph/compare")
if not p_dir.exists():
    p_dir.mkdir(parents=True)

#グラフの保存
plt.savefig('./result/train/exp_area_graph/compare/' + date1 + '.png')

#グラフの表示
plt.show()

print("Showing Exp Area Compare graph is completed.")