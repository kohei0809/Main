...
if __name__ == "__main__":
    ...
    train_logger = log_manager.createLogWriter("train3")
    test_logger = log_manager.createLogWriter("test3")
    ...
    if shuffle == True:
        ...
        train_logger = log_manager.createLogWriter("train3_shuffle")
        test_logger = log_manager.createLogWriter("test3_shuffle")
        # モデルのパラメータを保存するディレクトリを作成
        save_dir = "model_checkpoints_2sentences_shuffle"
        ...
        test_logger = log_manager.createLogWriter("test3")
        # モデルのパラメータを保存するディレクトリを作成
        save_dir = "model_checkpoints_2sentences"
        os.makedirs(save_dir, exist_ok=True)
