...
from habitat_baselines.rl.ppo.policy import ProposedNetOracle
...
class PPOOracle(nn.Module):
    def __init__(
        self,
        actor_critic: ProposedNetOracle,
        clip_param: float,
        ppo_epoch: int,
        num_mini_batch: int,
    ...
    def get_advantages(self, rollouts: RolloutStorageOracle) -> Tensor:
        advantages = (
    ...
    def update(self, rollouts: RolloutStorageOracle) -> Tuple[float, float, float]:
