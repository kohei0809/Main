...
class BaseRLTrainerOracle(BaseTrainer):
    ...
    def _pause_envs(
        ...
        current_episode_exp_area: Tensor,
        current_episode_picture_value: Tensor,
        current_episode_similarity: Tensor,
        current_episode_picsim: Tensor,
        current_episode_subgoal_reward: Tensor,
        prev_actions: Tensor,
        ...
        if len(envs_to_pause) > 0:
            ...
            current_episode_subgoal_reward = current_episode_subgoal_reward[state_index]
